...
class PecheAuxMoules{
	...
	// cas d'un mur isolée sans voisin
	// ooo
	// oxo
	// ooo
	...
	for(int i=0;i<nbJoueurs;i++){
	    Couleur c=new Couleur(28,185,37);
	    if(i==1)
		c=new Couleur(104,184,248);
	    if(i==2)
		c=new Couleur(248,80,40);
	    if(i==3)
		c=new Couleur(248,88,248);
	    try{
	...
	try{
		...
		if(nbTourMax!=-1 && tour>=nbTourMax*nbJoueurs)
		    ...
		    output.write("Tous les trésors ont été ramassés en "+tour+" tours.\n");
	    }
	    else
